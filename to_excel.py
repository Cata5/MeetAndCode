...
for humidity, temperature, mq135_data in zip(humidity_matches, temperature_matches, mq135_data_matches):
    data_dict = {
        'Humidity': [humidity],
...
df[['Humidity', 'Temperature', 'MQ135 RZero', 'Corrected RZero', 'Resistance', 'PPM', 'Corrected PPM']].to_excel(excel_writer, sheet_name='Data', index=False)
